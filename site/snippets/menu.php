<?php if ($page == 'home' OR $page == 'about' OR $page == 'contact' ){ ?>
<div class="navbar-wrapper">
  <?php } ?>
  <div class="container">
    <!-- Static navbar -->
    <nav class="navbar <?php if ($page == 'home' OR $page == 'about' OR $page == 'contact'){ ?>navbar-inverse <?php } else { ?>navbar-default<?php } ?>">
